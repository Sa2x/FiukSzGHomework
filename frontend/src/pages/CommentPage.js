...
export default function CommentPage() {
  ...
  const getComments = async () => {
    try {
      await api
        .get(`/${image.id}/comments/`, { headers: authHeader() })
  ...
  const addComment = async () => {
    ...
    await api
      .post(`/${image.id}/comments/new`, message, { headers: authHeader() })
      .then(() => {
        getComments();
  ...
  const handleDelete = async (comment_id) => {
    try {
      await api
        .delete(`/${image.id}/comments/del/${comment_id}`, {
          headers: authHeader(),
        })
        .then(() => {
          getComments();
  ...
  return (
    <Container>
      ...
      {isLoaded ? <img src={image.previewUrl} alt="Logo" /> : <div />}
